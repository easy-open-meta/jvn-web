        ...
        if (comments_open()) {
            ...
            <input name="%1$s" type="submit" id="%2$s" class="%3$s" value="%4$s" /></div>',
                ...
                'fields' => apply_filters('comment_form_default_fields', array(
                    ...
                    'cookies' => '<div style="display: none" class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes" checked="checked"></div>'
                )),
                'logged_in_as' => '',
                'comment_notes_before' => '',
