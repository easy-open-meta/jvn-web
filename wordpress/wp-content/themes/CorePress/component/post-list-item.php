...
//$postitem['time'] = get_the_time('Y-m-d h:i:s',$post);
$postitem['time'] = format_date(get_post_time('U', false, $post));

$newpost = '';
if ($set['theme']['postlist_newnote'] == 1) {
    if (date("Y-m-d") == date("Y-m-d",get_post_time('U', false, $post))) {
                    ...
                    <div class="post-item-meta">
                        <div class="post-item-meta-item">
                            ...
                            <span class="post-item-time"><i
                                        class="fas fa-calendar-alt"></i><?php echo $postitem['time']; ?></span>
                        </div>
            ...
            <div class="post-item-meta">
                <div class="post-item-meta-time">
                 <span class="post-item-meta-author">
                    ...
                    <span class="post-item-time"><?php echo $postitem['time']; ?></span>
                </div>
                <div class="item-post-meta-other">
                    <?php
                    if ($postitem['views'] !== null) {
