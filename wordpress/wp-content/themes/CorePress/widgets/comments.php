            ...
            <li>
                <div class="widger-comment-plane">
                        ...
                        <div class="widger-comment-user">
                            <div class="widger-avatar">
                                <img class="user-avatar" width="30" height="30"
                                     src="<?php echo corepress_get_avatar_url($comment->comment_author_email) ?>">
                            </div>
                    ...
                    <p class="widger-comment-postlink">
                        评论于 <a href="<?php echo get_permalink($comment->comment_post_ID); ?>"
                               target="_blank"><?php echo get_the_title($comment->comment_post_ID); ?></a>
                    </p>
                </div>
